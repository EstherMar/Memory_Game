package com.phoenix.memorygame.ui;
...
import static com.phoenix.memorygame.common.Shared.*;

public class PopupWonView<mInterstitialAd> extends RelativeLayout {
	...
	public PopupWonView(Context context, AttributeSet attrs) {
		...
		mBackButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				eventBus.notify(new BackGameEvent());
			}
		});
		...
		mNextButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				eventBus.notify(new NextGameEvent());
			}
		});
	}
